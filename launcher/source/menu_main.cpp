...
Menus::Enum MenuCredits()
{
	...
	GuiImageData* Credits1TestaImageData;
	GuiImageData* Credits2TestaImageData;
	GuiImageData* Credits3TestaImageData;
	GuiImageData* Credits4TestaImageData;

	GuiImage* Credits1TestaImage;
	GuiImage* Credits2TestaImage;
	GuiImage* Credits3TestaImage;
	GuiImage* Credits4TestaImage;

	Credits1TestaImageData = new GuiImageData(credit1_png);
	Credits2TestaImageData = new GuiImageData(credit2_png);
	Credits3TestaImageData = new GuiImageData(credit3_png);
	Credits4TestaImageData = new GuiImageData(credit4_png);

	Credits1TestaImage = new GuiImage(Credits1TestaImageData);
	Credits2TestaImage = new GuiImage(Credits2TestaImageData);
	Credits3TestaImage = new GuiImage(Credits3TestaImageData);
	Credits4TestaImage = new GuiImage(Credits4TestaImageData);

	GuiButton* Credit1Testa = new GuiButton(Credits1TestaImageData->GetWidth(), Credits1TestaImageData->GetHeight());
	Credit1Testa->SetImage(Credits1TestaImage);
	Credit1Testa->SetAlignment(ALIGN_LEFT, ALIGN_TOP);
	Credit1Testa->SetPosition(0, 0);
	Window->Append(Credit1Testa);

	ResumeGui();
	sleep(5);
	Window->Remove(Credit1Testa);

	GuiButton* Credit2Testa = new GuiButton(Credits2TestaImageData->GetWidth(), Credits2TestaImageData->GetHeight());
	Credit2Testa->SetImage(Credits2TestaImage);
	Credit2Testa->SetAlignment(ALIGN_LEFT, ALIGN_TOP);
	Credit2Testa->SetPosition(0, 0);
	Window->Append(Credit2Testa);

	sleep(5);
	Window->Remove(Credit2Testa);

	GuiButton* Credit3Testa = new GuiButton(Credits3TestaImageData->GetWidth(), Credits3TestaImageData->GetHeight());
	Credit3Testa->SetImage(Credits3TestaImage);
	Credit3Testa->SetAlignment(ALIGN_LEFT, ALIGN_TOP);
	Credit3Testa->SetPosition(0, 0);
	Window->Append(Credit3Testa);

	sleep(5);
	Window->Remove(Credit3Testa);

	GuiButton* Credit4Testa = new GuiButton(Credits4TestaImageData->GetWidth(), Credits4TestaImageData->GetHeight());
	Credit4Testa->SetImage(Credits4TestaImage);
	Credit4Testa->SetAlignment(ALIGN_LEFT, ALIGN_TOP);
	Credit4Testa->SetPosition(0, 0);
	Window->Append(Credit4Testa);
	sleep(5);
	Window->Remove(Credit4Testa);
	return Menus::Main;
}
...
Menus::Enum MenuMain()
{
	...
	GuiImageData* InstallTestaImageData;
	GuiImageData* InstallTestaOverImageData;

	GuiImage* InstallTestaImage;
	GuiImage* InstallTestaOverImage;
	...
	InstallTestaImageData = new GuiImageData(installover_png);
	InstallTestaOverImageData = new GuiImageData(installover2_png);
	...
	InstallTestaImage = new GuiImage(InstallTestaImageData);
	InstallTestaOverImage = new GuiImage(InstallTestaOverImageData);
	...
	OptionsTesta->SetPosition(-18, 122);
	...
	UpdateTesta->SetPosition(377, 122);
	...
	LaunchTesta->SetPosition(179, 122);
	...
	ExitTesta->SetPosition(279, 237);
	ExitTesta->SetTrigger(&Trigger[Triggers::Select]);
	Window->Append(ExitTesta);

	GuiButton* InstallTesta = new GuiButton(InstallTestaImageData->GetWidth(), InstallTestaImageData->GetHeight());
	InstallTesta->SetImage(InstallTestaImage);
	InstallTesta->SetImageOver(InstallTestaOverImage);
	InstallTesta->SetAlignment(ALIGN_LEFT, ALIGN_TOP);
	InstallTesta->SetPosition(84, 237);
	InstallTesta->SetTrigger(&Trigger[Triggers::Select]);
	Window->Append(InstallTesta);
	...
	while (true) {
		...
		else if (LaunchTesta->GetState() == STATE_CLICKED) {
			return Menus::Launch;
		} 
		...
		else if (InstallTesta->GetState() == STATE_CLICKED) {
			Window->Remove(OptionsTesta);
			Window->Remove(InstallTesta);
			Window->Remove(ExitTesta);
			Window->Remove(LaunchTesta);
